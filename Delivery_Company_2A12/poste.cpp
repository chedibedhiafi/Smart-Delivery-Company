...
QSqlQueryModel * Poste::chercher(int codeposte)
{
    QSqlQueryModel * model=new QSqlQueryModel();
    QSqlQuery query;
    query.prepare("SELECT * from POSTES where CODEPOSTE like :codeposte order by CODEPOSTE ");
    query.bindValue(":codeposte",codeposte);
    query.exec();
